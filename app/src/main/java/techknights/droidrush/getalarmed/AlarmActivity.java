...
public class AlarmActivity extends AppCompatActivity  {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        ringtone.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                custom.putExtra(RingtoneManager.EXTRA_RINGTONE_TITLE, "Select Alarm Tone");
    ...
    public void confirmAlarm() {
        ...
        if (setTime == null) {
            ...
            myDb.alarmInsertData(RQS-1,setTime,alarmName,uri.toString(),whatisit,impLevelValue);
            setTime=null;
        }
        Intent i = new Intent(AlarmActivity.this, MainActivity.class);
        startActivity(i);
